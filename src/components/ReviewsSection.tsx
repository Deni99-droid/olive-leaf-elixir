...
const reviews = [
  ...
  },
  {
    ...
    text: "Маме 72 года. Начала принимать Олайф в декабре 2025. Утреннее повышение давления почти исчезло — можно обходиться без таблеток. Прошли боли в спине от грыжи позвоночника. Наладилась работа ЖКТ. Головокружения стали значительно реже.",
