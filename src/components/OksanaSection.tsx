      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          <p className="text-lg font-light text-green-soft leading-relaxed mb-5">
            Я сама попробовала Олайф и была удивлена результатом. Теперь делюсь этим открытием с другими — искренне верю в силу этого продукта.
          </p>
          <p className="text-lg font-light text-green-soft leading-relaxed">
            Рада приветствовать вас в моём интернет-магазине! Приглашаю познакомиться с уникальной научно запатентованной продукцией OLife — возможно, это станет такой же находкой для вашей семьи, как и для моей.
          </p>
        </div>
      </div>
    </div>
